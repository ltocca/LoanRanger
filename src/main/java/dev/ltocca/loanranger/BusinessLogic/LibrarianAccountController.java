...
public class LibrarianAccountController {
    ...
    public LibrarianAccountController(Librarian librarian) throws SQLException {
    ...
    public void changeUsername(String newUsername) {
        ...
        if (newUsername.trim().equals(this.librarian.getUsername())) {
        ...
        try {
            ...
            this.librarian.setUsername(newUsername.trim());
            this.userDAO.updateUsername(this.librarian.getId(), newUsername.trim());
        } catch (Exception e) {
    ...
    public void changeEmail(String newEmail) {
        ...
        if (newEmail.trim().equalsIgnoreCase(this.librarian.getEmail())) {
        ...
        try {
            ...
            this.librarian.setEmail(newEmail.trim());
            this.userDAO.updateEmail(this.librarian.getId(), newEmail.trim());
        } catch (Exception e) {
    ...
    public void changePassword(String currentPassword, String newPassword) {
        ...
        if (!PasswordHasher.check(currentPassword, this.librarian.getPassword())) {
            throw new IllegalArgumentException("Error: The current password you entered is incorrect.");
        }

        try {
            String hashedPassword = PasswordHasher.hash(newPassword);
            this.userDAO.updatePassword(this.librarian.getId(), hashedPassword);
            this.librarian.setPassword(hashedPassword);
        } catch (Exception e) {
